		...
		switch ( extension ) {
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setLibraryPath( './example/jsm/libs/rhino3dm/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setDecoderPath( './example/js/libs/draco/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					dracoLoader.setDecoderPath( './example/js/libs/draco/gltf/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setPath( '../example/models/ldraw/officialLibrary/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { PCDLoader } = await import( '../example/jsm/loaders/PCDLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { USDZLoader } = await import( '../example/jsm/loaders/USDZLoader.js' );
