...
render();
	...
	signals.objectSelected.add( function ( object ) {
		...
		if ( object !== null && object !== scene && object !== camera ) {
			...
			mateiralColor.style.pointerEvents = "unset";
			...
			mateiralColor.style.opacity = 0.3;
			mateiralColor.style.pointerEvents = "none";
		}
...
render();
	...
	function animate() {
		...
		if ( needsUpdate === true ) window.renderer = renderer;
render();
